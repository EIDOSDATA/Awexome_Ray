...
//          Console.Write("rx:" + iRecSize.ToString());
    ...
    private void 홈페이지로ToolStripMenuItem_Click(object sender, EventArgs e)
    {
      System.Diagnostics.Process p = System.Diagnostics.Process.Start("http://whiteat.com/227059", "");
